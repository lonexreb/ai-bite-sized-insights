...
export function HeroSection() {
  return (
    <div className="relative overflow-hidden bg-background py-12 md:py-16 lg:py-20">
      ...
      <div className="absolute top-0 left-0 w-24 h-24 bg-brand-light-purple rounded-full opacity-40 -translate-x-1/2 -translate-y-1/3"></div>
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="text-center lg:text-left">
            <div className="inline-block bg-brand-light-purple text-brand-purple rounded-full px-4 py-1.5 text-sm font-medium mb-6">
              Stay ahead in the AI revolution
            </div>
            <h1 className="scroll-m-20 text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
              Learn <span className="text-brand-purple">AI</span> in simple, digestible bites
            </h1>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-brand-light-purple to-brand-soft-yellow p-1 rounded-2xl">
              <div className="bg-white rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <Button className="w-full mt-5">Read now</Button>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-8 -left-8 w-16 h-16 bg-brand-light-purple rounded-lg -rotate-12 animate-float"></div>
          </div>
        </div>
      </div>
    </div>
